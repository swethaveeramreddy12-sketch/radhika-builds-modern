      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex gap-3"><Phone className="w-4 h-4 mt-0.5 text-[var(--gold)] shrink-0" /> +91 98765 43210</li>
            <li className="flex gap-3"><Mail className="w-4 h-4 mt-0.5 text-[var(--gold)] shrink-0" /> hello@radhikaconstructions.com</li>
          </ul>
        </div>
      </div>
